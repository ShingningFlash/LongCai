<template>
	<view>
		<view style="width: 690rpx;height:690rpx;margin: 0 auto;margin-top: 20rpx;border: 1rpx solid #fff;background-color: #fff;">
		...
		<u-action-sheet :actions="list"  :show="show" @select="select"></u-action-sheet>
	</view>
</template>
