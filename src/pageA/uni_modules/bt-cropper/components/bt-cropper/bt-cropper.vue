	...
	methods: {
		...
		initCropper() {
			...
			if (containerRate > cropperRate) {
				cropperRect.height = this.containerRect.height * 1;  //0.85
			...
			//   // 使用图片的宽高比作为默认裁剪框的宽高比
			//   cropperRect.width = this.containerRect.width * 0.85;
			//   cropperRect.height = cropperRect.width / imageRate;
			
			//   // 根据图片宽高比和裁剪框的宽高，计算出图像的宽高
			//   imageRect.width = cropperRect.width;
			//   imageRect.height = imageRect.width / imageRate;
			
			//   // 计算图像和裁剪框的左上角坐标，使它们居中于容器
			//   imageRect.left = (this.containerRect.width - imageRect.width) / 2;
			//   imageRect.top = (this.containerRect.height - imageRect.height) / 2;
			...
			//   // 一寸照片的宽高比约为1:1.5
			//   const oneInchRatio = 1 / 1.5;
			
			//   // 使用一寸照片的宽高比作为裁剪框的宽高比
			//   cropperRect.width = this.containerRect.width * 0.85;
			//   cropperRect.height = cropperRect.width / oneInchRatio;
			
			//   // 如果裁剪框的高度超过容器的高度，将其调整为容器的高度
			//   if (cropperRect.height > this.containerRect.height) {
			//     cropperRect.height = this.containerRect.height;
			//     cropperRect.width = cropperRect.height * oneInchRatio;
			//   }
			...
			//   cropperRect.left = (this.containerRect.width - cropperRect.width) / 2;
			//   cropperRect.top = (this.containerRect.height - cropperRect.height) / 2;
			...
			//   // 使用一寸照片的宽高比作为裁剪框的宽高比
			//   cropperRect.width = this.containerRect.width * 0.85;
			//   cropperRect.height = cropperRect.width / 0.85;
