<template>
	<view>
		<view class="commodity">
			<view class="commodityTitle">退货商品</view>
		...
		<view class="reason">
			<view class="reasonTitle">
				...
				<view class="right">
					<view>￥{{orderInfo.total_amount}}</view>
				</view>
			</view>
			<view class="reasonTitle">
				...
				<view class="right" @click='showPicker'>
					...
					<view v-else>请选择退货原因</view>
					<image src="https://tm.ydlweb.com/icons/righticon.png"></image>
				</view>
			</view>
			<textarea placeholder="请描述申请售后服务的具体原因" v-model.trim="describe"></textarea>
			<view class="Imglist">
